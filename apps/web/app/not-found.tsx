      ...
      <div className="mx-auto min-h-[80svh] rounded-sheet bg-sheet px-400 py-900 split:px-700">
        <div className="mx-auto w-full max-w-[var(--container-page)]">
          ...
          <div className="mt-500 flex flex-wrap gap-100">
            <Link
              href="/"
              className="inline-flex items-center rounded-control bg-ink px-100 py-75 text-[15px] font-semibold text-ink-inverse transition-transform duration-180 ease-out active:scale-[0.98]"
            >
              Back to the start
            </Link>
            <a
              href={site.repo}
              className="inline-flex items-center rounded-control border border-rule-strong px-100 py-75 text-[15px] font-semibold text-ink transition-colors duration-180 ease-out hover:bg-hover"
            >
              View source
            </a>
          </div>
